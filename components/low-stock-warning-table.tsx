          ...
          <div className="block md:hidden space-y-3">
            {lowStockItems.map((item) => {
              ...
              return (
                <div
                  key={item.id}
                  className="p-3 bg-slate-800/40 rounded-xl border border-slate-800 space-y-2.5"
                >
                  ...
                  <div className="flex items-center justify-between text-xs border-t border-slate-800/60 pt-2">
                    <div>
                      <span className="text-slate-300 font-medium">{formatCurrency(item.selling_price)} / pc</span>
                      <span className="text-indigo-400 text-[10px] ml-1.5 font-semibold">
